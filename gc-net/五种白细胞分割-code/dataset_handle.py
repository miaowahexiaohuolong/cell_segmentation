...
def parse_label_to_onehot(label_path, img_size, num_classes=5):
    h, w = img_size
    mask = np.zeros((num_classes, h, w), dtype=np.float32)  # 5通道独热掩码
...
if __name__ == "__main__":
    dataset = ImageFolder(root_path="D:/ltf/五种白细胞分割-cls5-2.8k", mode='train')
    img, mask = dataset[0]
