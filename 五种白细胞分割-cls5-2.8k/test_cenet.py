...
def CE_Net_Test():
    ...
    solver.load('D:/阿里云盘/新建文件夹/数据集/数据集/五种白细胞分割-cls5-2.8k/weights/200.th')
    solver.net.eval()
...
Average Accuracy: 0.9925333440325144
Average Sensitivity: 0.9776168003750403
Average Dice: 0.9758740067481995
Average AUC: 0.986492400706778'''
